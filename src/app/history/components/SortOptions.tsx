...
interface SortOptionsProps {
  ...
  setSortField: Dispatch<SetStateAction<"timestamp" | "soundLevel" | "duration" | "nodes">>,
  sortOrder: "asc" | "desc",
  setSortOrder:Dispatch<SetStateAction<"asc" | "desc">>
}

const SortOptions = ({ sortField, setSortField, sortOrder, setSortOrder }: SortOptionsProps) => {
  const handleSortChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    setSortField(e.target.value as "timestamp" | "soundLevel" | "duration"|"nodes");
  };
